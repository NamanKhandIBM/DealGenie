...
export const NS1_QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    allowOther: true,
    options: [
      { label: "< 30 million (Essentials tier)",  value: "20" },
      { label: "30 – 50 million (Standard tier)", value: "40" },
  ...
  },
  {
    ...
    subtext: "1K records included on all tiers. CPQ quantity = thousands (1 qty = 1,000 records).",
    type: "single",
    allowOther: true,
    options: [
      { label: "1,000 (minimum / included)", value: "1000" },
  ...
  },
  {
    ...
    ask: "How many filter chains (traffic steering policies) do they need?",
    subtext: "Essentials: 1 included. Standard: 1 included, up to 99 add-on (D10AUZX). Premium: unlimited via D0GNKZX.",
    type: "single",
    allowOther: true,
    options: [
      { label: "None / just the 1 included", value: "0" },
      { label: "2 – 10",                     value: "5" },
      { label: "10 – 50",                    value: "25" },
      { label: "50 – 99",                    value: "75" },
      { label: "100+ (Premium needed)",      value: "100" },
    ],
  ...
  {
    key: "monitors",
    ask: "How many health-check monitors (Jobs) do they need?",
    subtext: "Essentials/Standard: 2 included, up to 98 add-on (D10B2ZX). 1 monitor = 1 Job = 1 hostname/IP.",
    type: "single",
    allowOther: true,
    options: [
      { label: "None / just included (2)", value: "0" },
      { label: "3 – 50",                  value: "25" },
      { label: "51 – 98",                 value: "75" },
      { label: "99+ (Premium needed)",    value: "150" },
    ],
  ...
  },
  {
    ...
    subtext: "D10ATZX (Standard) or D0GN5ZX (Premium). Covers traffic spikes beyond contracted volume.",
    type: "single",
    options: [
      { label: "No",   value: "no" },
      { label: "Yes",  value: "yes" },
  ...
  {
    key: "nxd",
    ask: "Do they need Non-Existent Domain (NXD) Waiver? (Premium only)",
    subtext: "D0GNMZX — waives charges for NXDOMAIN failed-lookup queries.",
    type: "single",
    options: [
      { label: "No",   value: "no" },
      { label: "Yes",  value: "yes" },
  ...
  {
    key: "gslb",
    ask: "Do they need RUM-based traffic steering (GSLB)?",
    subtext: "Real User Monitoring for geo/performance routing. Premium: D0GNQZX/D0GNNZX. Hybrid: D0GZ0ZX/D0GYYZX.",
    type: "single",
    options: [
      { label: "No",                                    value: "no" },
  ...
  {
    key: "insights",
    ask: "Do they need DNS Insights (observability & analytics)? (Premium only)",
    subtext: "D0GN6ZX — qty in CPQ must equal Managed DNS Requests (D0GNEZX).",
    type: "single",
    options: [
      { label: "No",   value: "no" },
      { label: "Yes",  value: "yes" },
  ...
  },
  {
    ...
    subtext: "Adding headroom prevents overage charges during the contract term.",
    type: "single",
    options: [
      { label: "None",   value: "0" },
      { label: "10%",    value: "10" },
